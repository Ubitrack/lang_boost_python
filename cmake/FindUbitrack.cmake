...
FIND_UBITRACK_HEADER( UBITRACK_RENDERAPI_INCLUDE_DIR utVisualization/RenderAPI/utRenderAPI.h )
if(UBITRACK_RENDERAPI_INCLUDE_DIR)
	MESSAGE(STATUS "Found Ubitrack RenderAPI: ${UBITRACK_RENDERAPI_INCLUDE_DIR}")
	set(HAVE_UBITRACK_RENDERAPI ON)
endif(UBITRACK_RENDERAPI_INCLUDE_DIR)
...
if(HAVE_UBITRACK_RENDERAPI)
	set(UBITRACK_LIBRARIES_NEEDED ${UBITRACK_LIBRARIES_NEEDED} "utrenderapi")
endif(HAVE_UBITRACK_RENDERAPI)
